...
const FormItemWrap = <T,>(props: FormItemProps & {displayName: string; func: (...args: T[]) => React.ReactNode} & T) => {
  const formContext = useContext(FormContext)
  const {displayName, func} = props
...
export const FormItem =
  <T,>(func: (...args: T[]) => React.ReactNode, displayName: string) => (props: T) => <FormItemWrap {...props} func={func} displayName={displayName} />
