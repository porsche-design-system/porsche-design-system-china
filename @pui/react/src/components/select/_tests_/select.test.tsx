...
describe('Select', () => {
  ...
  it('filters options by text input', () => {
    ...
    const { getByRole, getByText, queryByText } = render(
      <Select
        ...
        filterInput
        filterInputPlaceholder="test filter"
      />
    )
  ...
  it('controls by another event', () => {
    ...
    ;['Option1', 'Option2', 'Option3'].forEach(text =>
  ...
  it('renders the bottom element when list is open ', () => {
    const options = [{ text: 'Option 1', value: 'option1' }]
    const onValueChange = jest.fn()
  ...
  it('renders option list by display config, separator is - ', () => {
    ...
    waitFor(() => {
      userEvent.click(getByRole('button'))
      ;['option1-选项1', 'option2-选项2', 'option3-选项3'].forEach(text =>
        expect(getByText(text)).toBeInTheDocument()
      )
    })
  })
