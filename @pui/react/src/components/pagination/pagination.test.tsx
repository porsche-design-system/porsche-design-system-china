...
describe('test Pagination component', () => {
  ...
  it('should render the correct full pagaination', () => {
    ...
    const moreInfo = document.getElementsByClassName(
      'pui-pagination-more-info'
    )[0]
  ...
  it('should render the correct right pagaination', () => {
    ...
    expect(
      document.getElementsByClassName('pui-pagination')[0].getAttribute('style')
    ).toEqual('justify-content: end;')
  })
